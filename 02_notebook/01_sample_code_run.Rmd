...
Without further adjusting the model specifications given by the example page, OLS can give very different estimate and lower standard errors than (some of) DML's output, but the DML-Lassos' standard errors may not differ that much/ be much lower than other algo.
